...
CREATE TABLE `__new_blocked_user` (
	...
	`created_at` numeric DEFAULT '2025-07-06T02:20:50.212Z' NOT NULL,
...
CREATE TABLE `__new_draft_post` (
	...
	`created_at` numeric DEFAULT '2025-07-06T02:20:50.211Z' NOT NULL,
	`updated_at` numeric DEFAULT '2025-07-06T02:20:50.211Z' NOT NULL,
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE TABLE `__new_notification_settings` (
	...
	`created_at` numeric DEFAULT '2025-07-06T02:20:50.212Z' NOT NULL,
	`updated_at` numeric DEFAULT '2025-07-06T02:20:50.212Z' NOT NULL,
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE TABLE `__new_profile` (
	...
	`created_at` numeric DEFAULT '2025-07-06T02:20:50.210Z' NOT NULL,
	`updated_at` numeric DEFAULT '2025-07-06T02:20:50.210Z' NOT NULL,
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE TABLE `__new_seen_post_log` (
	`user_id` text NOT NULL,
	`post_id` text NOT NULL,
	`seen_at` numeric DEFAULT '2025-07-06T02:20:50.212Z' NOT NULL,
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE no action,
	FOREIGN KEY (`post_id`) REFERENCES `post`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`apple_id` text,
	`created_at` numeric DEFAULT '2025-07-06T02:20:50.208Z' NOT NULL,
	`updated_at` numeric DEFAULT '2025-07-06T02:20:50.209Z' NOT NULL
);
--> statement-breakpoint
