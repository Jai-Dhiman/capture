...
CREATE TABLE `comment` (
	...
	`created_at` numeric DEFAULT '2025-03-23T11:54:49.201Z' NOT NULL,
...
CREATE TABLE `hashtag` (
	`id` text PRIMARY KEY NOT NULL,
	`name` text NOT NULL,
	`created_at` numeric DEFAULT '2025-03-23T11:54:49.202Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `post` (
	...
	`created_at` numeric DEFAULT '2025-03-23T11:54:49.200Z' NOT NULL,
	FOREIGN KEY (`user_id`) REFERENCES `profile`(`user_id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE TABLE `profile` (
	...
	`created_at` numeric DEFAULT '2025-03-23T11:54:49.195Z' NOT NULL,
	`updated_at` numeric DEFAULT '2025-03-23T11:54:49.199Z' NOT NULL
);
--> statement-breakpoint
