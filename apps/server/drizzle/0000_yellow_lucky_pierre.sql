...
CREATE TABLE `blocked_user` (
	...
	`created_at` numeric DEFAULT '2025-05-25T22:04:17.455Z' NOT NULL,
...
CREATE TABLE `comment` (
	...
	`created_at` numeric DEFAULT '2025-05-25T22:04:17.454Z' NOT NULL,
...
CREATE TABLE `notification_settings` (
	...
	`created_at` numeric DEFAULT '2025-05-25T22:04:17.455Z' NOT NULL,
	`updated_at` numeric DEFAULT '2025-05-25T22:04:17.455Z' NOT NULL,
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE TABLE `profile` (
	...
	`created_at` numeric DEFAULT '2025-05-25T22:04:17.454Z' NOT NULL,
	`updated_at` numeric DEFAULT '2025-05-25T22:04:17.454Z' NOT NULL,
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE TABLE `users` (
	...
	`phone` text,
	`created_at` numeric DEFAULT '2025-05-25T22:04:17.447Z' NOT NULL,
	`updated_at` numeric DEFAULT '2025-05-25T22:04:17.452Z' NOT NULL
);
--> statement-breakpoint
