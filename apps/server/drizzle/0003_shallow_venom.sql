...
CREATE TABLE `__new_captag` (
	...
	`name` text NOT NULL,
	`created_at` numeric DEFAULT '2025-02-14T05:33:20.020Z' NOT NULL
);
...
CREATE TABLE `__new_post` (
	...
	`user_id` text,
	`content` text NOT NULL,
	`created_at` numeric DEFAULT '2025-02-14T05:33:20.019Z' NOT NULL,
	FOREIGN KEY (`user_id`) REFERENCES `profile`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE TABLE `__new_profile` (
	...
	`created_at` numeric DEFAULT '2025-02-14T05:33:20.016Z' NOT NULL,
	`updated_at` numeric DEFAULT '2025-02-14T05:33:20.018Z' NOT NULL
);
--> statement-breakpoint
