...
CREATE TABLE `__new_profile` (
	...
	`created_at` numeric DEFAULT '2025-02-14T05:42:04.691Z' NOT NULL,
	`updated_at` numeric DEFAULT '2025-02-14T05:42:04.695Z' NOT NULL
);
...
CREATE TABLE `__new_captag` (
	`id` text PRIMARY KEY NOT NULL,
	`name` text NOT NULL,
	`created_at` numeric DEFAULT '2025-02-14T05:42:04.698Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_media` (
	...
	`created_at` numeric DEFAULT '2025-02-14T05:42:04.697Z' NOT NULL,
	FOREIGN KEY (`user_id`) REFERENCES `profile`(`id`) ON UPDATE no action ON DELETE no action,
	FOREIGN KEY (`post_id`) REFERENCES `post`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE TABLE `__new_post` (
	...
	`user_id` text,
	`content` text NOT NULL,
	`created_at` numeric DEFAULT '2025-02-14T05:42:04.696Z' NOT NULL,
	FOREIGN KEY (`user_id`) REFERENCES `profile`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
