...
CREATE TABLE `__new_profile` (
	...
	`created_at` numeric DEFAULT '2025-01-31T22:53:41.401Z' NOT NULL,
	`updated_at` numeric DEFAULT '2025-01-31T22:53:41.407Z' NOT NULL
);
--> statement-breakpoint
INSERT INTO `__new_profile`("id", "supabase_user_id", "username", "profile_image", "bio", "verified_type", "created_at", "updated_at") SELECT "id", "supabase_user_id", "username", "profile_image", "bio", "verified_type", "created_at", "updated_at" FROM `profile`;--> statement-breakpoint
DROP TABLE `profile`;--> statement-breakpoint
ALTER TABLE `__new_profile` RENAME TO `profile`;--> statement-breakpoint
PRAGMA foreign_keys=ON;--> statement-breakpoint
CREATE UNIQUE INDEX `profile_supabase_user_id_unique` ON `profile` (`supabase_user_id`);--> statement-breakpoint
CREATE UNIQUE INDEX `profile_username_unique` ON `profile` (`username`);--> statement-breakpoint
CREATE TABLE `__new_captag` (
	`id` text PRIMARY KEY NOT NULL,
	`name` text NOT NULL,
	`created_at` numeric DEFAULT '2025-01-31T22:53:41.409Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_post` (
	...
	`user_id` text,
	`content` text NOT NULL,
	`created_at` numeric DEFAULT '2025-01-31T22:53:41.408Z' NOT NULL,
	FOREIGN KEY (`user_id`) REFERENCES `profile`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE TABLE `__new_relationship` (
	...
	`follower_id` text,
	`followed_id` text,
	`created_at` numeric DEFAULT '2025-01-31T22:53:41.410Z' NOT NULL,
