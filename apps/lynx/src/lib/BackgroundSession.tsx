// src/components/session/BackgroundSession.tsx
...
export function BackgroundSession({ children }: { children: React.ReactNode }) {
  'background only';
  ...
  // Handle session requests from main thread
  useEffect(() => {
